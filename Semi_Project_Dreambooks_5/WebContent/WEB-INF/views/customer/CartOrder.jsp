       ...
       $(function(){
    	   ...
    	   if($("#agreement_checkbox").is(":checked") == false) {
    		   ...
    		   let $frm = $("[name=basketBuyFrm]");
    			$frm.attr('action','<%=request.getContextPath()%>/user/cartpay')
    				.attr('method','get')
    				.submit();
    	   });
   ...
   <h2>주문 목록</h2>
        <div id="container">
                          ...
                          <tr>
                             <td>
                                <img src="<%=request.getContextPath() %>/images/<%= c.getBookImgRenameFileName()==null? 
				            				c.getBookImgOriginalFileName() : c.getBookImgRenameFileName() %>" alt="" class="bookImg" "/> <br />
                                <input type="hidden" class="bookNo" value="<%=c.getBookNo()%>"/>
                            ...
                            <td>
                             ...
                             <td>                     
                                <label class="bPrice4" for=""><%=c.getCartTotalPrice() %></label>
                                <span>원</span>
              ...
              <div id="buyBasketBook" style="padding:5px">   
                 <table id="orderTable" class="order4">
                    <tr>
                       ...
                       <td>                     
                          <span id="sumBookPrice4"><%=sum %></span>
                     ...
                     <tr class="totalP"  style="border-bottom: 1px solid black;"">
                       ...
                       <td>                     
                          <span class="price4 total4" id="sumTotalPrice4"><%=sum %></span>
            ...
            <form name="basketBuyFrm">
            	<% for(CartExtends c : list){ %>
                <input type="hidden" value="<%=c.getBookNo()%>" name="bookNo"/>
                <%} %>
